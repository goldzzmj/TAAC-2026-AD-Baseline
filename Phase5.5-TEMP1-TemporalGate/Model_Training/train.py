...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_temporal_gate', action='store_true', default=False,
                        help='Use time-conditioned feature gating for temporal drift modeling')
    parser.add_argument('--no_temporal_gate', dest='use_temporal_gate', action='store_false')
