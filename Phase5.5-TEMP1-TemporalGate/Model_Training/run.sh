...
# Phase5.5-TEMP1: Time-conditioned Feature Gating
# Only change vs T2 baseline:
#   --use_temporal_gate (multiplicative temporal gate on sequence token features)
#
...
"${PYTHON_BIN_CMD[@]}" -u "${SCRIPT_DIR}/train.py" \
    --run_name "${RUN_NAME:-phase5_5_temp1_temporal_gate}" \
