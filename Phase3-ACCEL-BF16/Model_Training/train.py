...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_compile', action='store_true', default=False,
                        help='Use torch.compile(model) for training acceleration')
    parser.add_argument('--use_bf16', action='store_true', default=False,
                        help='Use BF16 mixed precision training via torch.autocast')
...
def main() -> None:
    ...
    if args.use_bf16:
        logging.info("BF16 mixed precision training enabled")
