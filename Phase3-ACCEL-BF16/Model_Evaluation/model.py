...
class RankMixerNSTokenizer(nn.Module):
    ...
    def forward(self, int_feats: torch.Tensor) -> torch.Tensor:
        ...
        # NOTE: torch.split returns views (non-contiguous), which causes
        # CUBLAS_STATUS_EXECUTION_FAILED when BF16-trained weights are loaded
        # for FP32 inference. .contiguous() ensures safe cuBLAS matmul strides.
