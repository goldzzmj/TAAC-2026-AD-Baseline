...
# Phase5.5-DOM1: Domain-level Dynamic Reliability Gating
# Only change vs T2 baseline:
#   --use_domain_gate (dynamic weighting of behavior domains based on item context)
#
...
"${PYTHON_BIN_CMD[@]}" -u "${SCRIPT_DIR}/train.py" \
    --run_name "${RUN_NAME:-phase5_5_dom1_domain_gate}" \
