...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_domain_gate', action='store_true', default=False,
                        help='Use domain-level reliability gating to dynamically weight behavior domains')
    parser.add_argument('--no_domain_gate', dest='use_domain_gate', action='store_false')
...
def main() -> None:
    ...
    model_args = {
        ...
        "use_domain_gate": args.use_domain_gate,
    }
