...
def parse_args() -> argparse.Namespace:
    ...
    # SEQ-1: seq_c fid47 removal
    parser.add_argument('--seq_c_fid47_removed', action='store_true', default=False,
                        help='Remove fid47 from seq_c sideinfo features')
...
def main() -> None:
    ...
    train_loader, valid_loader, pcvr_dataset = get_pcvr_data(
        ...
        seq_c_fid47_removed=args.seq_c_fid47_removed,
    )
