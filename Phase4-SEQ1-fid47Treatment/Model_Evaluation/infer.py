...
def main() -> None:
    ...
    # ---- Resolve seq_c_fid47_removed from train_config ----
    seq_c_fid47_removed = train_config.get('seq_c_fid47_removed', False)
    logging.info(f"seq_c_fid47_removed: {seq_c_fid47_removed}")
