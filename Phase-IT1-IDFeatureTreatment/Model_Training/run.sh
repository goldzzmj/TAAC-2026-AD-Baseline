...
# Phase-IT1: ID Feature Treatment
# Changes vs QRY1 baseline:
#   --emb_skip_threshold 100000 (from 1000000)
#   --emb_hash_size 50000 (from 0)
#   --id_sparse_lr 0.01 (ID sparse params differential LR)
#   --id_weight_decay 0.1
#   --id_vocab_threshold 100000
#   --ns_id_dropout 0.02 (NS tokenizer ID dropout)
#   --ns_id_vocab_threshold 100000
#   --use_target_aware_query (retained from QRY1)
#
# All other params identical to QRY1 (cosine LR + warmup baseline).
...
"${PYTHON_BIN_CMD[@]}" -u "${SCRIPT_DIR}/train.py" \
    --run_name "${RUN_NAME:-phase_it1_id_feature_treatment}" \
