...
# Phase-OPT1: Muon Optimizer
# Only change vs QRY1 baseline:
#   --dense_optimizer_type muon --muon_lr 0.02 --muon_momentum 0.95 --muon_weight_decay 0.01
#
# All other params identical to QRY1 (cosine LR + warmup + target-aware query baseline).
...
"${PYTHON_BIN_CMD[@]}" -u "${SCRIPT_DIR}/train.py" \
    --run_name "${RUN_NAME:-phase_opt1_muon_optimizer}" \
