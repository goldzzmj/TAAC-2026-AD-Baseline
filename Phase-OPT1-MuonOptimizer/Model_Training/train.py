...
def parse_args() -> argparse.Namespace:
    ...
    # Dense optimizer type (Muon experiment).
    parser.add_argument('--dense_optimizer_type', type=str, default='adamw',
                        choices=['adamw', 'muon'],
                        help='Dense optimizer type: adamw or muon')
    parser.add_argument('--muon_lr', type=float, default=0.02,
                        help='Learning rate for Muon optimizer (2D params)')
