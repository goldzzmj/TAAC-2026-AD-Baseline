...
# Phase1-T2: Cosine LR scheduler with warmup
# Only change vs Phase0 baseline:
#   lr_scheduler=cosine (was: none)
#   warmup_steps=500 (was: 0)
#   min_lr_ratio=0.1 (was: 0.1, unchanged)
#
...
"${PYTHON_BIN_CMD[@]}" -u "${SCRIPT_DIR}/train.py" \
    --run_name "${RUN_NAME:-phase1_t2_cosine_lr}" \
