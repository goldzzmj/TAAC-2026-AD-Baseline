...
# Phase5.5-QRY1: Target-Aware Query Interface
# Only change vs T2 baseline:
#   --use_target_aware_query (DIN-style target-conditioned pooling in query generator)
#
...
"${PYTHON_BIN_CMD[@]}" -u "${SCRIPT_DIR}/train.py" \
    --run_name "${RUN_NAME:-phase5_5_qry1_target_aware_query}" \
