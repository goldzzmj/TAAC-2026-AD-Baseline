...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_dense_mlp', action='store_true', default=False,
                        help='Use 2-layer MLP for user dense projection instead of single Linear')
    parser.add_argument('--no_dense_mlp', dest='use_dense_mlp', action='store_false')
...
def main() -> None:
    ...
    model_args = {
        ...
        "use_dense_mlp": args.use_dense_mlp,
    }
