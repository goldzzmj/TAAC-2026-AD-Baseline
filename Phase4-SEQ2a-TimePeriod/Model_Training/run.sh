...
# Phase4-SEQ2a: Time Period Features (sinusoidal encoding)
# Only change vs T2 baseline:
#   +use_time_period (new feature: hour_of_day + day_of_week sinusoidal)
#
...
"${PYTHON_BIN_CMD[@]}" -u "${SCRIPT_DIR}/train.py" \
    --run_name "${RUN_NAME:-phase4_seq2a_time_period}" \
