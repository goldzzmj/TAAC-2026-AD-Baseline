...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_time_period', action='store_true', default=False,
                        help='Enable sinusoidal time period features (hour_of_day, day_of_week)')
    parser.add_argument('--no_time_period', dest='use_time_period', action='store_false',
                        help='Disable time period features (default)')
...
def main() -> None:
    ...
    model_args = {
        ...
        "use_time_period": args.use_time_period,
    }
