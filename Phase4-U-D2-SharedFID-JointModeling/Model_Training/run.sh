...
# Phase4-U-D2: Shared-FID Joint Modeling
# Only change vs T2 baseline:
#   --use_shared_fid_joint (joint modeling of shared-fid int embeddings and dense values)
#
...
"${PYTHON_BIN_CMD[@]}" -u "${SCRIPT_DIR}/train.py" \
    --run_name "${RUN_NAME:-phase4_u_d2_shared_fid_joint}" \
