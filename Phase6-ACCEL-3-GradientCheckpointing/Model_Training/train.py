...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--save_last_n', type=int, default=5,
...
def main() -> None:
    ...
    trainer = PCVRHyFormerRankingTrainer(
        ...
        feature_mask_ratio=0.0 if args.save_last_n > 0 else 0.0,
        save_last_n=args.save_last_n,  # Keep last N checkpoints
