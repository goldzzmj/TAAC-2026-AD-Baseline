...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_deep_classifier', action='store_true', default=False,
                        help='Use 3-layer deep classifier (64→128→64→1) instead of 2-layer (64→64→1)')
    parser.add_argument('--no_deep_classifier', dest='use_deep_classifier', action='store_false')
...
def main() -> None:
    ...
    model_args = {
        ...
        "use_deep_classifier": args.use_deep_classifier,
    }
